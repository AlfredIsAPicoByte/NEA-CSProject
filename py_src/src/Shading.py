...
from CommonUtils import unit, attenuate_distance_exponential, safe_asin, safe_norm
from PrimaryStructures import TracingRay, HitInfo
from Scene import Scene
from Luminance import Color, ColorGradient, PBRMaterial, MaterialType, LightSource
...
class ShadingStrategy(ABC):
    def __init__(
            self,
            ambience_settings: AmbienceSettings,
            shadow_settings: ShadowSettings,
            background_settings: BackgroundSettings
        ):
        self.ambience_settings = ambience_settings
