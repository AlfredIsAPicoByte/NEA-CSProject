...
class LightRay(Color, Ray):
    def __init__(self, origin: np.ndarray, direction: np.ndarray, color: Color, intensity: float = 1.0, name: str = "Light Ray"):
    ...
    @property
    def ray(self):
        return Ray(self.origin, self.direction, self.name)
