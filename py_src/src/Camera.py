...
class Camera:
    ...
    """
    def __init__ (self, transform: Transform, fov: float, near: float, far: float, width: int, height: int, camType: CameraType = CameraType.PERSPECTIVE, camMode: CameraMode = CameraMode.FIRST_PERSON, speed: float = 5.0, speed_multiplier: float = 2.0, sensitivity: float = 10.0, name: str = "Camera", id: int = 0):
        """
